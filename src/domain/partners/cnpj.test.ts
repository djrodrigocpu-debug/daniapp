...
import { CNPJ_DIGITS, formatCnpj, isValidCnpj, normalizeCnpj, validateCnpj } from './cnpj';
...
describe('fronteira: parceiro não é usuário', () => {
  it('o módulo não expõe nada relacionado a identidade ou credencial', async () => {
    ...
    expect(exportados).toEqual(['CNPJ_DIGITS', 'formatCnpj', 'isValidCnpj', 'normalizeCnpj', 'validateCnpj']);
